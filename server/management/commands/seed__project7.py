...
class Command(BaseCommand):
    ...
    def generate_project_with_tasks(self):
        ...
        tasks_by_role = {
            "backend": [
                ("Разработка API управления активами #1", "adopted_customer", 42, 71, "положительный", True, True),
                ...
                ("Разработка микросервисов учета #5", "adopted_customer", 36, 34, "положительный", True, True),
                ...
                ("Модуль журналирования ошибок #8", "adopted_customer", 28, 26, "положительный", True, True),
                ("API документация Swagger #9", "adopted_customer", 26, 25, "негативный", True, True),
                ("Настройка политик доступа #10", "adopted_customer", 22, 21, "положительный", True, True),
                ...
                ("Обработка логов и метрик #14", "adopted_customer", 31, 29, "негативный", True, True),
                ("Валидация входящих данных #15", "adopted_customer", 29, 127, "положительный", True, True),
                ("Создание экспортных модулей #16", "adopted_customer", 25, 23, "положительный", True, True),
            ],
            "frontend": [
                ("Интерфейс управления активами #1", "adopted_customer", 140, 38, "положительный", True, True),
                ("Дашборды состояния ресурсов #2", "adopted_customer", 36, 44, "положительный", True, True),
                ("Форма создания активов #3", "adopted_customer", 28, 27, "негативный", True, True),
                ("Фильтрация и поиск по параметрам #4", "adopted_customer", 24, 43, "положительный", True, True),
                ("Отображение связей между объектами #5", "adopted_customer", 30, 29, "положительный", True, True),
                ("Адаптивная верстка интерфейсов #6", "adopted_customer", 26, 35, "негативный", True, True),
                ("Механизмы уведомлений #7", "adopted_customer", 22, 21, "положительный", True, True),
                ("Интерфейс редактирования объектов #8", "adopted_customer", 120, 169, "положительный", True, True),
                ("Привязка к картам активов #9", "adopted_customer", 34, 33, "негативный", True, True),
                ("История изменений и версионность #10", "adopted_customer", 28, 36, "положительный", True, True),
                ("Поддержка темной темы #11", "adopted_customer", 18, 17, "негативный", True, True),
                ("Работа с вложенными элементами #12", "adopted_customer", 23, 32, "положительный", True, True),
                ("Анимация и интерактивность #13", "adopted_customer", 219, 118, "положительный", True, True),
                ("Стилизация форм и таблиц #14", "adopted_customer", 25, 24, "негативный", True, True),
                ("Модальные окна и диалоги #15", "adopted_customer", 27, 46, "положительный", True, True),
                ("Подключение к API для визуализации #16", "adopted_customer", 32, 30, "положительный", True, True),
                ("Работа с WebSocket #17", "adopted_customer", 21, 20, "негативный", True, True),
            ],
            "integration": [
                ("Интеграция с системами SAP #1", "adopted_customer", 40, 70, "положительный", True, True),
                ...
                ("Интеграция с системами учета движения #7", "adopted_customer", 24, 93, "положительный", True, True),
                ("Резервное взаимодействие через SOAP #8", "adopted_customer", 18, 17, "негативный", True, True),
            ],
            "database": [
                ("Разработка схемы хранения активов #1", "adopted_customer", 38, 36, "положительный", True, True),
                ("Индексация по типам объектов #2", "adopted_customer", 32, 30, "негативный", True, True),
                (
                ...
                ("Настройка журналирования PostgreSQL #6", "adopted_customer", 24, 52, "положительный", True, True),
                ("Обеспечение отказоустойчивости базы #7", "adopted_customer", 20, 19, "положительный", True, True),
                ("Создание сложных представлений для отчетов #8", "adopted_customer", 25, 23, "негативный", True, True),
            ],
            "devops": [
                ("Организация CI/CD через GitLab #1", "adopted_customer", 36, 34, "положительный", True, True),
                ("Автоматизация деплоя через Ansible #2", "adopted_customer", 30, 48, "положительный", True, True),
                ("Мониторинг через Zabbix и Prometheus #3", "adopted_customer", 28, 26, "негативный", True, True),
                ("Управление секретами Vault #4", "adopted_customer", 24, 23, "положительный", True, True),
                ("Настройка Kubernetes кластера #5", "adopted_customer", 32, 40, "негативный", True, True),
                ("Инфраструктура как код (Terraform) #6", "adopted_customer", 26, 25, "положительный", True, True),
            ],
            "ux_ui": [
                (
                "Пользовательские сценарии редактирования #1", "adopted_customer", 28, 37, "положительный", True, True),
                ("Дизайн управления объектами #2", "adopted_customer", 126, 215, "негативный", True, True),
                ("Оценка UX интерфейсов #3", "adopted_customer", 24, 22, "положительный", True, True),
                ("Проверка на доступность (a11y) #4", "adopted_customer", 20, 39, "негативный", True, True),
                ("Создание макетов с Figma #5", "adopted_customer", 22, 21, "положительный", True, True),
                ("Участие в юзабилити-тестах #6", "adopted_customer", 18, 37, "положительный", True, True),
            ],
            "testing": [
                ("E2E тесты цепочек операций #1", "adopted_customer", 26, 25, "положительный", True, True),
                ("Интеграционные тесты API #2", "adopted_customer", 24, 22, "положительный", True, True),
                ("Тестирование отказоустойчивости #3", "adopted_customer", 22, 20, "негативный", True, True),
                ("Тест-кейсы для мобильной версии #4", "adopted_customer", 20, 18, "положительный", True, True),
                ("Нагрузочные тесты хранения активов #5", "adopted_customer", 18, 17, "положительный", True, True),
            ],
        }
